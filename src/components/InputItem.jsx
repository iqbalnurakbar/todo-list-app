      ...
      <div>
        ...
        <div className="mt-2 flex flex-col items-center mb-4">
          <textarea
            ...
            className="mx-10 mb-2 rounded-md border-2 p-2 w-full md:w-1/2"
          ...
          <textarea
            ...
            className="mx-auto mb-2 rounded-md border-2 p-1 w-full md:w-1/2"
            placeholder="Ketik catatan disini..."
          />
          <span className="mb-2 p-1 text-xs">Sisa karakter untuk judul: {remainingCharacters}</span>
          <button
